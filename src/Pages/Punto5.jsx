  ...
  return (
    <>
        ...
        <div className='p-3 flex flex-col gap-5 px-5 py-5 shadow-lg mt-5 bg-white rounded-xl font-medium justify-center'>
            ...
            <div className='h-44 w-fit mx-auto flex justify-center flex-col'>
                <a href="https://docs.google.com/spreadsheets/d/1NJQheZFz799wvmXfmGOVpQvr5KMy0Qqb21FepkAGhDE/edit#gid=0" target='_blank' className='h-fit' >
                    <img className='mx-auto h-40 hover:h-44 transition-all' alt="Sheets" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Google_Sheets_logo_%282014-2020%29.svg/800px-Google_Sheets_logo_%282014-2020%29.svg.png?20201024100414" />
                </a>
            </div>
        </div>
    </>
