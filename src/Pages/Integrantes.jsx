  ...
  return (
        <>
            ...
            <div className='p-3 flex flex-col gap-5 px-5 py-5 shadow-lg mt-5 bg-white rounded-xl font-medium'>
                ...
                <Link to='/Punto1' className='w-fit'>Punto número <span className="text-indigo-500"> 1</span></Link>
                <h2 className='text-indigo-500 font-black text-3xl'>Rios <span className='text-black'>Tomás</span></h2>
                <Link to='/Punto2' className='w-fit'>Punto número <span className="text-indigo-500"> 2</span></Link>
                <h2 className='text-indigo-500 font-black text-3xl'>Gaye <span className='text-black'>Micaela</span></h2>
                <Link to='/Punto3' className='w-fit'>Punto número <span className="text-indigo-500"> 3</span></Link>
                <h2 className='text-indigo-500 font-black text-3xl'>Tarcay <span className='text-black'>Matias</span></h2>
                <Link to='/Punto4' className='w-fit'>Punto número <span className="text-indigo-500"> 4</span></Link>
                <h2 className='text-indigo-500 font-black text-3xl'>Palavecino <span className='text-black'>Julián</span></h2>
                <Link to='/Punto5' className='w-fit'>Punto número <span className="text-indigo-500"> 5</span></Link>
