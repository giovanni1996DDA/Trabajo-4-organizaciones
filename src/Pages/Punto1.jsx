  ...
  return (
    <div className=" flex flex-col p-5 ">
        ...
        <div className='p-3 flex flex-col gap-5 px-5 py-5 shadow-lg mt-5 bg-white rounded-xl font-medium'>
            ...
            <p><span className='font-bold'>g)</span>	Registro de Acciones: ¿Las acciones están siendo coordinadas? Es importante considerar o ponerse en el lugar de la persona que continuará la gestión de cobranza. Mejores Prácticas en Estrategias de Cobranza 4 </p>
